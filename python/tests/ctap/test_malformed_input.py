    ...
    def test_long_request_short_buffer(self):
        for dname_len in range(10, 50):
            ...
            res = self.ctap2.device.call(0x10, bytes.fromhex(
                ...
                + display_name +
                "0482A263616C672664747970656A7075626C69632D6B6579A263616C6739010064747970656A7075626C69632D6B657906A26B6372656450726F74656374016B686D61632D736563726574F507A262726BF5627576F5"
            ))
            if dname_len == 10:
                self.assertEqual(CtapError.ERR.SUCCESS, res[0])
            else:
